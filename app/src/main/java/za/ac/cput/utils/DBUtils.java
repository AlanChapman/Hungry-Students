...
public class DBUtils {
    ...
    public static final String CREATE_USER_TABLE_QUERY = "CREATE TABLE IF NOT EXISTS " + STUDENT_TABLE + "(" + COLUMN_STUDENT_ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
    ...
    public static final String DROP_USER_TABLE_QUERY = "DROP TABLE IF EXISTS " + STUDENT_TABLE;
